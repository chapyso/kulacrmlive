                ...
                <div class="row">
                    <div class="col-xs-6">
                        <ol class="information__modal__ol">
                            <li>
                                <p><?= lang('vaccine_route_popup_message_one'); ?></p>
                            </li>
                            <li>
                                <p><?= lang('vaccine_route_popup_message_two'); ?></p>
                            </li>
                            <li>
                                <p><?= lang('vaccine_route_popup_message_three'); ?></p>
                            </li>
                            <li>
                                <p><?= lang('vaccine_route_popup_message_four'); ?></p>
                            </li>
                        </ol>
                    </div>
                    <div class="col-xs-6">
