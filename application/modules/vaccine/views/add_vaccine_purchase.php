...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            ...
            <div class="panel">
                <input type="hidden" id="vaccineAddAlert" value="<?php echo $this->report_model->getCountRow('vaccine', 'vcc_id', ['vcc_status' => 1]); ?>">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <select name="vp_vcc_id" id="vp_vcc_id" class="form-control js-example-basic-single " placeholder="" style="width: 100%;" required>
                                                    ...
                                                    <?php if (!empty($vaccines)) foreach ($vaccines as $list) { ?>
                                                        <option value="<?php echo $list->vcc_id; ?>"> <?php echo $list->vcc_name; ?> - (<?php echo $this->settings_model->getUnitById($list->vcc_unit_id)->un_name; ?>)
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" style="margin-top: 30px;">
                                                <span id="stockInVaccine"></span>
                                            </div>
                                        </div>
                                    </div>

                                    <form role="form" action="<?php echo base_url('') ?>vaccine/insertVaccinePurchase" method="post" id="formId" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-9">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control datepicker" name="vp_date" id="" value='<?= get_current_date(); ?>' placeholder="" autocomplete="off" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"> <?php echo lang('sub_total'); ?><span class="text-danger">*</span> </label>
                                                    <input type="text" class="form-control calculate_sub_total readonly" name="vp_sub_total" id="sub_total" value='' placeholder="" required>
                                                </div>

                                                <div class="form-group display_hide">
                                                    <label for="exampleInputEmail1"> <?php echo lang('discount'); ?> </label>
                                                    <input type="text" class="form-control calculate_grand_discount input__number" name="vp_grand_discount" id="" value='' placeholder="">
                                                </div>
                                                <div class="form-group display_hide">
                                                    <label for="exampleInputEmail1"> <?php echo lang('amount_payable'); ?><span class="text-danger">*</span> </label>
                                                    <input type="text" class="form-control calculate_grand_total readonly" name="vp_grand_total" id="grand_total" value='' placeholder="" required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 note">
                                                        <textarea class="form-control" name="vp_description" value="" rows="5" cols="10" style="height: auto !important;"> </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".form").click(function(e) {
            ...
            var vp_vcc_id = $("#vp_vcc_id option:selected").val();
            var vp_ls_text = $("#vp_vcc_id option:selected").text();
        ...
        $("body").on("click", ".product-cancel", function() {
            var vp_vcc_id = $(this).parents("tr").attr('data-vp_vcc_id');
            var vp_unit_price = $(this).parents("tr").attr('data-vp_unit_price');
            var vp_quantity = $(this).parents("tr").attr('data-vp_quantity');
            var vp_discount = $(this).parents("tr").attr('data-vp_discount');
            var vp_total = $(this).parents("tr").attr('data-vp_total');

            // $(this).parents("tr").find("td:eq(0)").text(vp_vcc_id);
        ...
        // Get vaccine Stock
        $("#vp_vcc_id").change(function() {
            var vp_vcc_id = $(this).val();
            // Product Price
            $.ajax({
                url: 'vaccine/getVaccineStockByJason?vcc_id=' + vp_vcc_id,
                method: 'GET',
                data: '',
                dataType: 'json',
            }).success(function(response) {
                $("#stockInVaccine").html("<h4>In stock: " + response.vaccineWiseStock + " <?php echo $settings->unit; ?> </h4>");
            });
        });
...
<script>
    $(document).ready(function() {
        ...
        // shed quantity alert
        function vaccineAddAlert() {
            var vaccineAddAlert = $("#vaccineAddAlert").val();

            if (vaccineAddAlert == 0) {
                toastr.warning('<?= lang('no_vaccine_found'); ?>');
            }
        }
        vaccineAddAlert();
    });
