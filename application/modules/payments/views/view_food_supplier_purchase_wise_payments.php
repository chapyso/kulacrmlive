            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="adv-table editable-table ">
                        <div class="clearfix">
                            <a href="<?php echo base_url("payments/viewSupplierWisePayment?id=$purchaseInformationById->fdps_s_id"); ?>">
                                <div class="btn-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="new__cards__auto card__box">
                                    <div class="col-xs-3">
                                        ...
                                        <table class="table">
                                            <tr>
                                                <?php $supplierById = $this->settings_model->getSingleData('supplier', ['s_id' => $purchaseInformationById->fdps_s_id, 's_status' => 1]); ?>
                                                <td width="40%">
                                                ...
                                                <td width="60%">
                                                    ...
                                                    <p><strong><?= lang('type'); ?>:</strong> <?php $typeName = $this->supplier_model->getData('supplier_type', ['st_id' => $supplierById->s_st_id, 'st_status' => 1], $supplierById->s_st_id)->row();
                                                                                                if ($typeName) {
                                                                                                    echo $typeName->st_name;
                                                                                                } else {
                                    ...
                                    <div class="col-xs-3">
                                        ...
                                        <div class="row">
                                            <div class="text-center">
                                                ...
                                                <h3> <?php $purchaseTotal = $purchaseInformationById->fdps_grand_total;
                                                        if ($purchaseTotal) {
                                    ...
                                    <div class="col-xs-3">
                                        ...
                                        <div class="row">
                                            <div class="text-center">
                                                ...
                                                <h3> <?php $supplierPaidAmount = $this->payments_model->getSumSupplierAndFoodPurchaseWiseTotalPaidAmount($supplierById->s_id, $purchaseInformationById->fdps_id);
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                            ...
                            <tbody>
                                <?php $serial = 0;
                                foreach ($paymentsByFoodPurchaseId as $list) {
                                    $serial++;
                                ?>
                                    <tr class="">
                                        <td> <?= $serial ?></td>
                                        ...
                                        <td>
                                            ...
                                            <form action="<?php echo base_url('payments/deleteSupplierPayments'); ?>" method="post" style="display:inline" onsubmit="return confirm('<?= lang('are_you_sure_want_to_delete_this_item'); ?>')">
                                                <input type="hidden" name="sp_fdps_id" value="<?php echo $list->sp_fdps_id; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info">
                ...
                <h4 class="modal-title"><strong><i class="fas fa-plus-circle"></i> <?= lang('edit_supplier_payments'); ?></strong></h4>
            </div>
                ...
                <form role="form" action="<?php echo base_url('payments/updateSupplierPayment') ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" class="form-control" id="due_amount_vaccine" placeholder="" readonly>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="sp_fdps_id" id="purchase_id" value=''>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".editFoodSupplierPayment").click(function(e) {
            ...
            $('#due_amount_vaccine').val("<?php echo $settings->currency; ?>" + due_amount);
