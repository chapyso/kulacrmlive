        ...
        <div class="col-md-12">
            <section class="panel">
                <header class="panel-heading">
                    <i class="fa fa-home"></i> <?= lang('purchase_wise_payments_list'); ?>
                </header>
                <div class="panel-body">
                    <div class="adv-table editable-table ">
                        <div class="clearfix">
                            <a href="<?php echo base_url("payments/viewSupplierWisePayment?id=$purchaseInformationById->vps_s_id"); ?>">
                                <div class="btn-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="new__cards__auto card__box">
                                    <div class="col-xs-3">
                                        ...
                                        <table class="table">
                                            <tr>
                                                <?php $supplierById = $this->settings_model->getSingleData('supplier', ['s_id' => $purchaseInformationById->vps_s_id, 's_status' => 1]); ?>
                                                <td width="40%">
                                    ...
                                    <div class="col-xs-3">
                                        ...
                                        <div class="row">
                                            <div class="text-center">
                                                ...
                                                <h3> <?php $purchaseTotal = $purchaseInformationById->vps_grand_total;
                                                        if ($purchaseTotal) {
                                    ...
                                    <div class="col-xs-3">
                                        ...
                                        <div class="row">
                                            <div class="text-center">
                                                ...
                                                <h3> <?php $supplierPaidAmount = $this->payments_model->getSumSupplierAndVaccinePurchaseWiseTotalPaidAmount($supplierById->s_id, $purchaseInformationById->vps_id);
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                            ...
                            <tbody>
                                <?php $serial = 0;
                                foreach ($paymentsByVaccinePurchaseId as $list) {
                                    $serial++;
                                ?>
                                    <tr class="">
                                        <td> <?= $serial ?></td>
                                        ...
                                        <td>
                                            ...
                                            <form action="<?php echo base_url('payments/deleteSupplierPayments'); ?>" method="post" style="display:inline" onsubmit="return confirm('<?= lang('are_you_sure_want_to_delete_this_item'); ?>')">
                                                <input type="hidden" name="sp_vps_id" value="<?php echo $list->sp_vps_id; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info">
                ...
                <h4 class="modal-title"><strong><i class="fa fa-plus-circle"></i> <?= lang('edit_supplier_payments'); ?></strong></h4>
            </div>
            <div class="modal-body" style="height: 100%;">
                <form role="form" action="<?php echo base_url('payments/updateSupplierPayment') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="sp_vps_id" id="purchase_id" value=''>
    ...
    $(document).ready(function() {
        ...
        $(".editFoodSupplierPayment").click(function(e) {
            ...
            $("#paid_amount").on('keyup change paste', function(e) {
                ...
                if (parseFloat(totalDueAmount) < parseFloat(payableAmountVaccine)) {
                    Swal.fire({
                        icon: "warning",
                        title: "<?= lang('warning'); ?>...",
