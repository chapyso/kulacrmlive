            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="adv-table editable-table ">
                        <div class="clearfix">
                            <a href="<?php echo base_url("payments/viewClientWisePayment?c_id=$saleInformationById->lsss_c_id"); ?>">
                                <div class="btn-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="new__cards__auto card__box">
                                    <div class="col-xs-3">
                                        ...
                                        <table class="table">
                                            <?php $clientById = $this->settings_model->getSingleData('client', ['c_id' => $saleInformationById->lsss_c_id, 'c_status' => 1]); ?>
                                            <tr>
                                                <td width="40%">
                                    ...
                                    <div class="col-xs-3">
                                        ...
                                        <div class="row">
                                            <div class="text-center">
                                                ...
                                                <h3> <?php $saleTotal = $saleInformationById->lsss_grand_total;
                                                        if ($saleTotal) {
                                    ...
                                    <div class="col-xs-3">
                                        ...
                                        <div class="row">
                                            <div class="text-center">
                                                ...
                                                <h3> <?php $clientReceivedAmount = $this->payments_model->getSumClientAndSaleWiseTotalReceivedAmount($clientById->c_id, $saleInformationById->lsss_id);
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                            ...
                            <tbody>
                                <?php $serial = 0;
                                foreach ($paymentsBySaleId as $list) {
                                    $serial++;
                                ?>
                                    <tr class="">
                                        <td> <?= $serial ?></td>
                                        ...
                                        <td>
                                            <button type="button" class="button button-warning editClientPayment" data-toggle="modal" data-payment-id="<?php echo $list->cp_id; ?>" data-client-id="<?php echo $list->cp_c_id; ?>" data-sale-id="<?php echo $list->cp_lsss_id; ?>" data-received-amount="<?php echo $list->cp_received_amount; ?>" data-paid_by="<?php echo $list->cp_paid_by; ?>" data-cheque_no="<?php echo $list->cp_cheque_no; ?>" data-reference="<?php echo $list->cp_reference; ?>" data-date="<?php echo date("$settings->date_format", strtotime($list->cp_date)); ?>" data-description="<?php echo $list->cp_description; ?>" data-client-name="<?php echo $clientById->c_name; ?>" data-total-due="<?php echo $totalDueAmount; ?>"><i class="fas fa-edit"></i> <?= lang('edit'); ?></button>
                                            <form action="<?php echo base_url('payments/deleteClientPayments'); ?>" method="post" style="display:inline" onsubmit="return confirm('<?= lang('are_you_sure_want_to_delete_this_item'); ?>')">
                                                <input type="hidden" name="cp_lsss_id" value="<?php echo $list->cp_lsss_id; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info">
                ...
                <h4 class="modal-title"><strong><i class="fa fa-plus-circle"></i> <?= lang('edit_client_payment'); ?></strong></h4>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Edit Client payment
        $(".editClientPayment").click(function(e) {
