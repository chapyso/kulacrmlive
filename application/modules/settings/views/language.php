                            ...
                            <div class="col-lg-12">
                                <section class="panel">
                                    <div class="panel-body">
                                        ...
                                        <form role="form" action="<?php echo base_url('settings/language'); ?>" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <select name="language" class="form-control js-example-basic-single" style="width: 100%;">
                                                    ...
                                                    <option value="luganda" <?php
                                                                            if (!empty($settings->language)) {
                                                                                if ($settings->language == 'luganda') {
                                                                                    echo 'selected';
                                                                                }
                                                                            }
                                                                            ?>><?php echo lang('luganda'); ?></option>

                                                    <option value="swahili" <?php
                                                                            if (!empty($settings->language)) {
                                                                                if ($settings->language == 'swahili') {
                                                                                    echo 'selected';
                                                                                }
                                                                            }
                                                                            ?>><?php echo lang('swahili'); ?></option>

                                                    <option value="runyankore" <?php
                                                                            if (!empty($settings->language)) {
                                                                                if ($settings->language == 'runyankore') {
                                                                                    echo 'selected';
                                                                                }
                                                                            }
                                                                            ?>><?php echo lang('runyankore'); ?></option>

                                                    <option value="lusoga" <?php
                                                                            if (!empty($settings->language)) {
                                                                                if ($settings->language == 'lusoga') {
                                                                                    echo 'selected';
                                                                                }
                                                                            }
                                                                            ?>><?php echo lang('lusoga'); ?></option>
