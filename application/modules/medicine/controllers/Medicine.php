...
class Medicine extends MY_Controller {
    ...
    public function addNew() {
        ...
        $this->form_validation->set_rules('no', 'Shed No', 'trim|required|min_length[1]|max_length[100]');
        // Validating Name Field
        $this->form_validation->set_rules('duration', 'Medicine Duration', 'trim|required|min_length[1]|max_length[100]');
        // Validating Medicines Field
        $this->form_validation->set_rules('p_date', 'Previous Medicine Date', 'trim|required|min_length[1]|max_length[100]');
        // Validating Amount Field   
        $this->form_validation->set_rules('n_date', 'Next Medicine Date', 'trim|required|min_length[1]|max_length[100]');

        $this->form_validation->set_rules('l_date', 'Last Medicine Date', 'trim|required|min_length[1]|max_length[100]');
