                        ...
                        <tbody>
                            ...
                            <?php foreach ($medicines as $medicine) { ?>
                                <tr class="">
                                    ...
                                    <td> <?php echo html_escape($medicine->no); ?></td>
                                    <td> <?php echo html_escape($medicine->duration); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <form action="<?php echo base_url('medicine/delete'); ?>" method="post" style="display:inline" onsubmit="return confirm('Are you sure you want to delete this item?');">
                                            <input type="hidden" name="id" value="<?php echo $medicine->id; ?>">
                                            <input type="hidden" name="action_token" value="<?php echo action_token(); ?>">
                                            <button type="submit" class="btn btn-xs"><i class="fa fa-times"></i>Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            <?php } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="medicine/addNew" method="post" enctype="multipart/form-data">
                    ...
                    <section class="">
                        <button type="submit" name="submit" class="button button-info submit_button">Submit</button>
                    </section>
                </form>
            </div>
        </div><!-- /.modal-content -->
