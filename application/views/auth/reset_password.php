...
<head>
    ...
    <title><?php echo lang('reset_password'); ?> | KulaCrm System &bull; v2026</title>
        ...
        <div class="auth-card">
            ...
            <?php if (!empty($message)): ?>
                <div class="flash-alert" role="alert">
                    ...
                    <p><?php echo lang('does_not_match'); ?></p>
                </div>
            <?php endif; ?>

            <form method="post" action="auth/reset_password/<?php echo $code; ?>">
                ...
                <button class="btn-submit" type="submit" name="submit" value="submit">
                    <span><?php echo lang('reset_password_submit_btn'); ?></span>
